...
public class FinalBitmap {
	...
	public void displayCircle(View imageView,String uri){	
		doDisplayCircle(imageView,uri,null);
	}
	...
	private void doDisplayCircle(View imageView, String uri, BitmapDisplayConfig displayConfig) {
		if(!mInit ){
			init();
		}
